...
toc: true
layout: post
description: Useful Linux and command line commands for my future self
categories: [tools, linux]
title: Linux
---

Notes on useful linux and mac command line functionality as reference for my future self.
